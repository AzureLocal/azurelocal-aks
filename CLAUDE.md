# azurelocal-aks — Claude Code Context
...
- `azurelocal-aks-engineer` (model: sonnet) — Expert in `azurelocal-aks`: deep knowledge of this repo's structure, conventions, and development workflow.
